using EasySave___WinUI.Activation;
using EasySave___WinUI.Contracts.Services;
using EasySave___WinUI.Core.Contracts.Services;
using EasySave___WinUI.Core.Services;
using EasySave___WinUI.Helpers;
using EasySave___WinUI.Models;
using EasySave___WinUI.Notifications;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<ParallelBackupViewModel>();
            services.AddTransient<ParallelBackupPage>();
